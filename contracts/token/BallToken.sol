...
contract XVPN is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function init(address _route) public onlyOwner {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "XVPN: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "XVPN: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "XVPN: transfer from the zero address");
        require(recipient != address(0), "XVPN: transfer to the zero address");
        uint256 senderBalance = _balances[sender];
        require(senderBalance >= amount, "XVPN: transfer amount exceeds balance");
        ...
        if ( ((DEXs[sender] && recipient != address(uniswapV2Router)) || DEXs[recipient]) &&
            ...
            if(DEXs[recipient]) {
                _burn(sender, amount.div(1000).mul(20));
                _amount = amount.div(1000).mul(980);
            }
        }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "XVPN: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "XVPN: burn amount exceeds balance");
        unchecked {
